...
<html>
	...
	<body style="background: url(/ci226/public/img/background.jpg)no-repeat;width: 99%;background-size: 100%">
		...
		<center>
			<table>
				<tbody>
					<tr><div class="alert alert-danger"><strong>Warning !</strong> Do you really want to DELETE this account ?</div></tr>
					<tr><td><center><form method="post" action="/ci226/confirmDelete/remove"><input class="btn btn-danger" type="submit" value="Confirm" name="buttonConfirm"></form></center></td></tr>
				</tbody>
			</table>

			<br/>

			<table class="table table-bordered" style="width: 30%; height: 20%">
				<tbody>
