...
<html>
	...
	<body style="background: url(/ci226/public/img/background.jpg)no-repeat;width: 99%;background-size: 100%">
		...
		<center>
			<h1>Sending Message to "{to}"</h1>
			<br/><br/>
			<h3>Write your message between 30 words</h3>
			<br/><br/><br/>

			<form method="POST" action="/ci226/message/sendMessage">
				<textarea class="form-control textarea-box" name="messageBody" rows="6" cols="60" style="padding: 5px" class="form-control"></textarea>
				</br></br>
				<input class="btn btn-default" type="submit" value="Send Message" name="buttonSend" class="form-control">
			</form>
		</center>
	</body>
</html>